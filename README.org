...
- foundations [1/3]
  ...
  - [-] block-and-inline [1/2]
    ...
    - [ ] [[https://github.com/rafaelbeirigo/odin-css-exercises/tree/main/foundations/block-and-inline/02-margin-and-padding-2][02-margin-and-padding-2]]
  - [ ] flex [0/7]
    - [ ] 01-flex-center
    - [ ] 02-flex-header
    - [ ] 03-flex-header-2
